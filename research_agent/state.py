...
class ResearchState(TypedDict, total=False):
    ...
    messages: Annotated[
        list[Any],
        "Only the most recent 5 completed user/assistant turns remain in graph state; this is written by finalize_response.",
    ]
    ...
    evaluation: Annotated[
        dict[str, Any],
        "Evaluation verdict, needs_improvement decision, and improvement scopes for the latest draft.",
    ]
