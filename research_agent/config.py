...
class Settings:
    ...
    rag_cross_encoder_model_id: str = os.getenv("CROSS_ENCODER_MODEL_ID", "BAAI/bge-reranker-v2-m3")
    rag_cross_encoder_enabled: bool = os.getenv("CROSS_ENCODER_ENABLED", "true").lower() == "true"
    rag_cross_encoder_batch_size: int = int(os.getenv("CROSS_ENCODER_BATCH_SIZE", "8"))
    rag_cross_encoder_local_files_only: bool = os.getenv("CROSS_ENCODER_LOCAL_FILES_ONLY", "false").lower() == "true"
